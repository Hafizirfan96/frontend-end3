...
?><head>
    ...
    <meta charset="utf-8">
    <title>Punjab Details Page</title>
      ...
      <div class="row demo-swatches-row">
	      <div class="swatches-col">
              ...
              <dl class="palette palette-green-sea">
                <dt>Male-GCT</dt>
                <dd>
<?php				$result = mysqli_query($conn,"SELECT sum(malegct) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-nephritis">
              <dt>Female-GCT</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(femalegct) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-belize-hole">
              <dt>Co.education</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(coeducation) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-midnight-blue">
              ...
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(male_vocational) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-orange">
              ...
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(female_vocational) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-pumpkin">
              <dt>Co.education</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(co_education_vocational) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-pomegranate">
              <dt>Total</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(total_vocational) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-silver">
              ...
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(male_enrollment) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-asbestos">
              ...
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(female_enrollment) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-green-sea">
              <dt>Total</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(total_enrollment) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
...
<div class="pallete-itemmineshift">
                ...
                <dd>22.2%<?php //echo $rowshift['morning'] ?></dd>
              </dl>
              <dl class="palette palette-green-sea">
                <dt><img src="img/arrow2.png">Evening</dt>
                <dd>1.2%<?php //echo $rowshift['evening'] ?></dd>
              </dl>
<dl class="palette palette-turquoise">
                <dt><img src="img/arrow2.png">Both</dt>
                <dd>76.6%<?php //echo $rowshift['bothshift'] ?></dd>
              </dl>
		      </div>
<!-- ---------------------------------------------------------------------------------- -->
	      </div> <!-- /swatches items -->
      ...
      <div class="row demo-swatches-row">
	      <div class="swatches-col">
            ...
            <dl class="palette palette-orange">
              ...
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(total_teaching_staff) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
              ...
              <dl class="palette palette-green-sea">
                <dt>Male Staff</dt>
                <dd><?php				$result = mysqli_query($conn,"SELECT sum(male_staff) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-nephritis">
              <dt>Female Staff</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(female_staff) FROM mapdata where province='Punjab'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
...
<div class="line"></div><br>
      <div class="row demo-swatches-row">
	      <div class="swatches-col">
            ...
            <dl class="palette palette-belize-hole">
              <dt>Dropout</dt>
              <dd>4874<?php	//			$result = mysqli_query($conn,"SELECT sum(dropout) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
...
<div class="row demo-swatches-rowmine" align="center">
	      <div class="swatches-col">
              ...
              <dl class="palette palette-green-sea">
                ...
                <dd>18.0<?php		//		$result = mysqli_query($conn,"SELECT sum(student_teacher_ratio) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			//	 echo $row['sum(student_teacher_ratio)']; }?></dd>
              ...
              <dd>1.3%<?php //echo $rowstatus['govt_job'] ?></dd>
			  <dt><img src="img/arrow2.png">Private Job</dt>
              <dd>18.5%<?php //echo $rowstatus['private_job'] ?></dd>
			  <dt><img src="img/arrow2.png">Self Employment</dt>
              <dd>24.2%<?php //echo $rowstatus['self_employment'] ?></dd>
			  <dt><img src="img/arrow2.png">Unemployed</dt>
              <dd>45.6%<?php //echo $rowstatus['unemployed'] ?></dd>
			  <dt><img src="img/arrow2.png">Abroad</dt>
              <dd>.1%<?php //echo $rowstatus['abrod'] ?></dd>
			  <dt><img src="img/arrow2.png">Higher Studies</dt>
              <dd>1.7%<?php //echo $rowstatus['higher_studies'] ?></dd>
			  <dt><img src="img/arrow2.png">Others</dt>
              <dd>8.5%<?php //echo $rowstatus['others'] ?></dd>
			  <dt><img src="img/arrow2.png">Internship</dt>
              <dd>.1%<?php //echo $rowstatus['internship'] ?></dd>			  
            </dl>
              </div>
		      <div class="pallete-itemmine">
			      <dl class="palette palette-peter-river">
...
<!--		  
	...
	-->		  
		      ...
		      <div class="pallete-itemmine">
			   ...
			   <dl class="palette palette-green-sea">
                ...
                <dd>78.7%<?php //echo $rowcondition['satisfactory'] ?></dd>
				<dt><img src="img/arrow2.png">Partially Satisfactory</dt>
                <dd>18.4%<?php //echo $rowcondition['partially_satisfactory'] ?></dd>
				<dt><img src="img/arrow2.png">Not Satisfactory</dt>
                <dd>2.9%<?php //echo $rowcondition['not_satisfactory'] ?></dd>
    ...
    <dl class="palette palette-turquoise">
                ...
                <dd>9.0%<?php	//			$result = mysqli_query($conn,"SELECT sum(library_facility) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
...
<dd><p align="center"><img src="img/aid.png" width="60" height="60"></p></dd>
                <dt>First Aid Kit</dt>
                <dd>73.5%<?php			//	$result = mysqli_query($conn,"SELECT sum(first_aid_kit) FROM mapdata") or die(mysqli_error());
	//	while ($row = mysqli_fetch_array($result)) {
		//		 echo $row['sum(first_aid_kit)'] }?></dd>
			  ...
			  <dd>98.8%<?php	//			$result = mysqli_query($conn,"SELECT sum(drinking_water) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			...
			<dt><p align="center"><img src="img/power.png" width="50" height="70"></p></dt>
              <dt>Electricity</dt>
			  <dd>100%<?php		//		$result = mysqli_query($conn,"SELECT sum(electricty) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			//	 echo $row['sum(electricty)'] }?></dd>
			  ...
			  <dd>85%<?php	//			$result = mysqli_query($conn,"SELECT sum(backup_source_of_electricty) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			...
			<dt><p align="center"><img src="img/Sports-Running.png" width="70" height="70"></p></dt>
			  ...
			  <dd>19.9%<?php	//			$result = mysqli_query($conn,"SELECT sum(sport_facility) FROM mapdata") or die(mysqli_error());
	//	while ($row = mysqli_fetch_array($result)) {
		//		 echo $row['sum(sport_facility)'] }?></dd>
              ...
              <dt>Toilet</dt>
              <dd>99.5%<?php	//			$result = mysqli_query($conn,"SELECT sum(toilet) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			...
			<dt><p align="center"><img src="img/hostel.png" width="60" height="70"></p></dt>
              ...
              <dd>7.2%<?php		//		$result = mysqli_query($conn,"SELECT sum(hostel_facility) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			//	 echo $row['sum(hostel_facility)'] }?></dd>
              ...
              <dd>21.5%<?php	//			$result = mysqli_query($conn,"SELECT sum(transport_facility) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			 ...
			 <dt><p align="center"><img src="img/wifi.png" width="70" height="70"></p></dt>
              ...
              <dd>98.9%<?php			//	$result = mysqli_query($conn,"SELECT sum(internet_facility) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
