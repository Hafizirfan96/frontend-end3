      ...
      <div class="row demo-swatches-row">
	      <div class="swatches-col">
              ...
              <dl class="palette palette-green-sea">
                <dt>Male-GCT</dt>
                <dd>
<?php				$result = mysqli_query($conn,"SELECT sum(malegct) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-nephritis">
              <dt>Female-GCT</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(femalegct) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-belize-hole">
              <dt>Co.education</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(coeducation) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-midnight-blue">
              ...
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(male_vocational) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-orange">
              ...
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(female_vocational) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-pumpkin">
              <dt>Co.education</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(co_education_vocational) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-pomegranate">
              <dt>Total</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(total_vocational) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-silver">
              ...
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(male_enrollment) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-asbestos">
              ...
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(female_enrollment) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-green-sea">
              <dt>Total</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(total_enrollment) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
...
<div class="pallete-itemmineshift">
                ...
                <dd>33.3%<?php //echo $rowshift['morning'] ?></dd>
              </dl>
              <dl class="palette palette-green-sea">
                <dt><img src="img/arrow2.png">Evening</dt>
                <dd>50.0%<?php //echo $rowshift['evening'] ?></dd>
              </dl>
<dl class="palette palette-turquoise">
                <dt><img src="img/arrow2.png">Both</dt>
                <dd>16.7%<?php //echo $rowshift['bothshift'] ?></dd>
              </dl>
		      </div>
<!-- ---------------------------------------------------------------------------------- -->
	      </div> <!-- /swatches items -->
      ...
      <div class="row demo-swatches-row">
	      <div class="swatches-col">
            ...
            <dl class="palette palette-orange">
              ...
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(total_teaching_staff) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
              ...
              <dl class="palette palette-green-sea">
                <dt>Male Staff</dt>
                <dd><?php				$result = mysqli_query($conn,"SELECT sum(male_staff) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
            ...
            <dl class="palette palette-nephritis">
              <dt>Female Staff</dt>
              <dd><?php				$result = mysqli_query($conn,"SELECT sum(female_staff) FROM mapdata where province='Azad Jamu Kashmir'") or die(mysqli_error());
		while ($row = mysqli_fetch_array($result)) {
...
<div class="line"></div><br>
      <div class="row demo-swatches-row">
	      <div class="swatches-col">
            ...
            <dl class="palette palette-belize-hole">
              <dt>Dropout</dt>
              <dd>301<?php	//			$result = mysqli_query($conn,"SELECT sum(dropout) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
...
<?php		//		$result = mysqli_query($conn,"SELECT sum(student_teacher_ratio) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			//	 echo $row['sum(student_teacher_ratio)']; }?></dd>
              ...
              <dd>.0%<?php //echo $rowstatus['govt_job'] ?></dd>
			  <dt><img src="img/arrow2.png">Private Job</dt>
              <dd>.5%<?php //echo $rowstatus['private_job'] ?></dd>
			  <dt><img src="img/arrow2.png">Self Employment</dt>
              <dd>14.5%<?php //echo $rowstatus['self_employment'] ?></dd>
			  <dt><img src="img/arrow2.png">Unemployed</dt>
              <dd>85.0%<?php //echo $rowstatus['unemployed'] ?></dd>
			  <dt><img src="img/arrow2.png">Abroad</dt>
              <dd>.0%<?php //echo $rowstatus['abrod'] ?></dd>
			  <dt><img src="img/arrow2.png">Higher Studies</dt>
              <dd>.0%<?php //echo $rowstatus['higher_studies'] ?></dd>
			  <dt><img src="img/arrow2.png">Others</dt>
              <dd>.0%<?php //echo $rowstatus['others'] ?></dd>
			  <dt><img src="img/arrow2.png">Internship</dt>
              <dd>.0%<?php //echo $rowstatus['internship'] ?></dd>			  
            </dl>
              </div>
		      <div class="pallete-itemmine">
			      <dl class="palette palette-peter-river">
...
<!--		  
	...
	-->		  
		      ...
		      <div class="pallete-itemmine">
			   ...
			   <dl class="palette palette-green-sea">
                ...
                <dd>56.1%<?php //echo $rowcondition['satisfactory'] ?></dd>
				<dt><img src="img/arrow2.png">Partially Satisfactory</dt>
                <dd>28.0%<?php //echo $rowcondition['partially_satisfactory'] ?></dd>
				<dt><img src="img/arrow2.png">Not Satisfactory</dt>
                <dd>15.9%<?php //echo $rowcondition['not_satisfactory'] ?></dd>
    ...
    <dl class="palette palette-turquoise">
                ...
                <dd>19.7%<?php	//			$result = mysqli_query($conn,"SELECT sum(library_facility) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
...
<dd><p align="center"><img src="img/aid.png" width="60" height="60"></p></dd>
                <dt>First Aid Kit</dt>
                <dd>8.5%<?php			//	$result = mysqli_query($conn,"SELECT sum(first_aid_kit) FROM mapdata") or die(mysqli_error());
	//	while ($row = mysqli_fetch_array($result)) {
		//		 echo $row['sum(first_aid_kit)'] }?></dd>
			  ...
			  <dd>95.7%<?php	//			$result = mysqli_query($conn,"SELECT sum(drinking_water) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			...
			<dt><p align="center"><img src="img/power.png" width="50" height="70"></p></dt>
              <dt>Electricity</dt>
			  <dd>75.4%<?php		//		$result = mysqli_query($conn,"SELECT sum(electricty) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			//	 echo $row['sum(electricty)'] }?></dd>
			  ...
			  <dd>17.6%<?php	//			$result = mysqli_query($conn,"SELECT sum(backup_source_of_electricty) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			...
			<dt><p align="center"><img src="img/Sports-Running.png" width="70" height="70"></p></dt>
			  ...
			  <dd>8.0%<?php	//			$result = mysqli_query($conn,"SELECT sum(sport_facility) FROM mapdata") or die(mysqli_error());
	//	while ($row = mysqli_fetch_array($result)) {
		//		 echo $row['sum(sport_facility)'] }?></dd>
              ...
              <dt>Toilet</dt>
              <dd>76.0%<?php	//			$result = mysqli_query($conn,"SELECT sum(toilet) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			...
			<dt><p align="center"><img src="img/hostel.png" width="60" height="70"></p></dt>
              ...
              <dd>13.1%<?php		//		$result = mysqli_query($conn,"SELECT sum(hostel_facility) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			//	 echo $row['sum(hostel_facility)'] }?></dd>
              ...
              <dd>2.6%<?php	//			$result = mysqli_query($conn,"SELECT sum(transport_facility) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
			 ...
			 <dt><p align="center"><img src="img/wifi.png" width="70" height="70"></p></dt>
              ...
              <dd>26.8%<?php			//	$result = mysqli_query($conn,"SELECT sum(internet_facility) FROM mapdata") or die(mysqli_error());
		//while ($row = mysqli_fetch_array($result)) {
