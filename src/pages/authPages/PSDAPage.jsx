      ...
      <div className="Browse bg-[#478e51] mb-8">
        ...
        <div className="flex px-16  py-8">
          <div className=" p-4">
            ...
            >
              The Punjab Skills Development Authority (PSDA) is a regulatory
              body established in Punjab, Pakistan, to oversee the skills
              sector. Its primary objective is to ensure quality training and a
              skilled workforce by regulating and managing Technical and
              Vocational Education and Training (TVET) institutions,
              implementing national policies, and connecting supply with demand
              in the skills market.,
            </h3>
          </div>
