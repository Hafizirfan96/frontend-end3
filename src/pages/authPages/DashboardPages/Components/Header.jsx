      ...
      />
        ...
        <div>
              <h3 className="text-[12px] text-white ml-4">
                <h3 className="text-[30px]">UpSkill Punjab</h3>
      ...
      <nav className="bg-white mt-4 py-6">
          <div className="flex justify-evenly">
            ...
            >
              ...
              <h3 className="text-[13px] text-[#038837]">Trades</h3>
            </NavLink>
            ...
            >
              ...
              <h3 className="text-[13px] text-[#038837]">Workforce</h3>
            </NavLink>
            ...
            >
              <svg
                ...
                className="mb-1"
              >
                <path d="M12 2C8.13 2 5 5.13 5 9c0 3.87 5 11 7 13 2-2 7-9.13 7-13 0-3.87-3.13-7-7-7z" />
                <circle cx="12" cy="9" r="2.5" />
              </svg>
              <h3 className="text-[13px] text-[#038837]">Placement</h3>
            </NavLink>
